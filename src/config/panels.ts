...
export const PANEL_CATEGORY_MAP: Record<string, { labelKey: string; panelKeys: string[]; variants?: string[] }> = {
  ...
  opMarkets: {
    labelKey: 'header.panelCatMarkets',
    panelKeys: ['markets', 'forex', 'bonds', 'commodities', 'precious-metals-command', 'crypto', 'heatmap', 'macro-signals', 'etf-flows', 'stablecoins', 'polymarket'],
    variants: ['operator'],
  },
  opEconBanks: {
    labelKey: 'header.panelCatCentralBanks',
    panelKeys: ['centralbanks', 'economic', 'trade-policy', 'supply-chain', 'finance'],
    variants: ['operator'],
  },
  opGeopolitics: {
    labelKey: 'header.panelCatIntelligence',
    panelKeys: ['strategic-posture', 'cii', 'strategic-risk', 'geopolitics', 'middleeast', 'energy', 'thinktanks', 'telegram-intel', 'security-advisories'],
    variants: ['operator'],
  },
  opTechAi: {
    labelKey: 'header.panelCatTechAi',
    panelKeys: ['ai', 'ai-industry-tracker', 'aiResearch', 'tech', 'startups'],
    variants: ['operator'],
  },
  opDealsGulf: {
    labelKey: 'header.panelCatDeals',
    panelKeys: ['investmentIntel', 'dubai-real-estate-radar'],
    variants: ['operator'],
  },
  opGulfMena: {
    labelKey: 'header.panelCatGulfMena',
    panelKeys: ['gulf-economies', 'gcc-investments', 'gccNews', 'uaeBusiness', 'monitors', 'world-clock'],
    variants: ['operator'],
  },
};
