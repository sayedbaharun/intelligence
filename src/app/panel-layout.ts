    ...
    this.ctx.container.innerHTML = `
      <div class="header">
        ...
        return `
          ...
          <span class="logo">MONITOR</span><span class="logo-mobile">SENTINEL</span><span class="version">v${__APP_VERSION__}</span>${BETA_MODE ? '<span class="beta-badge">BETA</span>' : ''}
      ...
      <nav class="mobile-menu" id="mobileMenu">
        <div class="mobile-menu-header">
          <span class="mobile-menu-title">SENTINEL</span>
